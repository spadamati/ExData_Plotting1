## =========================== =================    ======= =========================
## Exploratory Data Analysis:  Peer Assessment 1 --- Plot 4  (Multiple Base Plots)
## =========================== =================    ======= =========================
...
## -------------------------------------------------------------------------------------------------------------------------------
  ...
  # Now,we can use this cleaned,processed and formatted data for plotting the Multiple Base plots.

## -------------------------------------------------------------------------------------------------------------------------------
##  Step 6: Construct/Set up the plot for Multiple Base plots and save it into PNG file ---> Plot 4
## -------------------------------------------------------------------------------------------------------------------------------

  png(filename = "plot4.png", width = 480, height = 480,units = "px", bg = "transparent")
  
  x <- par(mfrow=c(2,2)) # Figures are drawn in a 2*2 array on the device by rows
  
  ## SubPlot 1: TopLeft "Global_active_power"
  ## _______________________________________
  
  plot(df$Time,df$Global_active_power, type="l", xlab="", ylab="Global Active Power")
  
  
  ## SubPlot 2: TopRight "Voltage"
  ## ________________________________
  
  plot(df$Time,df$Voltage, type="l", xlab="datetime", ylab="Voltage")
  
  
  ## SubPlot 3: BottomLeft "Energy sub metering"
  ...
  #bty = "n" removes the border on the legend, 
  
  
  ## SubPlot 4: BottomRight "Global_reactive_power"
