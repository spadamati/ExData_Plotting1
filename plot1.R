## =========================== =================    ======= ===============
## Exploratory Data Analysis:  Peer Assessment 1 --- Plot 1  (Histogram)
## =========================== =================    ======= ===============
...
## -------------------------------------------------------------------------------------------------------------------------------
  ...
  # Now,we can use this cleaned,processed and formatted data for plotting the histogram.

## -------------------------------------------------------------------------------------------------------------------------------
##  Step 6: Construct/Set up the plot for histogram and save it into PNG file ---> Plot 1
## -------------------------------------------------------------------------------------------------------------------------------
