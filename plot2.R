## =========================== =================    ======= ===============
## Exploratory Data Analysis:  Peer Assessment 1 --- Plot 2  (Line Graph)
## =========================== =================    ======= ===============
...
## -------------------------------------------------------------------------------------------------------------------------------
  ...
  # Now,we can use this cleaned,processed and formatted data for plotting the Line Graph.

## -------------------------------------------------------------------------------------------------------------------------------
##  Step 6: Construct/Set up the plot for Line Graph and save it into PNG file ---> Plot 2
## -------------------------------------------------------------------------------------------------------------------------------
